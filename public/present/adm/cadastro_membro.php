...
Pesquisador</td>
            ...
            <tr>
              <td height="21"><input type="radio" name="nivel" value="Apoio" id="nivel_4" />
                Apoio</td>
            </tr>
        </table>          </td>
      </tr>
      ...
      <tr class="formularioSite">
        ...
        <td><label></label>
          <table width="499" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="451"><input name="tipo" type="radio" id="tipo" value="1" checked="checked" />
Equipe Atual</td>
            </tr>
            <tr>
