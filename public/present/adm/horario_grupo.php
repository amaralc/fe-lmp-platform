...
$query_rsse_01 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.se_01 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsse_01, "int"));
...
mysql_select_db($database_lmp, $lmp);
$query_rsse_02 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.se_02 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsse_02, "int"));
...
mysql_select_db($database_lmp, $lmp);
$query_rsse_03 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.se_03 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsse_03, "int"));
...
mysql_select_db($database_lmp, $lmp);
$query_rsse_04 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.se_04 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsse_04, "int"));
...
mysql_select_db($database_lmp, $lmp);
$query_rsse_05 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.se_05 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsse_05, "int"));
...
mysql_select_db($database_lmp, $lmp);
$query_rsse_06 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.se_06 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsse_06, "int"));
...
mysql_select_db($database_lmp, $lmp);
$query_rsse_07 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.se_07 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsse_07, "int"));
...
mysql_select_db($database_lmp, $lmp);
$query_rsse_08 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.se_08 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsse_08, "int"));
...
mysql_select_db($database_lmp, $lmp);
$query_rsse_09 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.se_09 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsse_09, "int"));
...
mysql_select_db($database_lmp, $lmp);
$query_rsse_10 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.se_10 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsse_10, "int"));
...
mysql_select_db($database_lmp, $lmp);
$query_rste_01 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.te_01 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rste_01, "int"));
...
$query_rste_02 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.te_02 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rste_02, "int"));
...
mysql_select_db($databate_lmp, $lmp);
$query_rste_03 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.te_03 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rste_03, "int"));
...
mysql_select_db($databate_lmp, $lmp);
$query_rste_04 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.te_04 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rste_04, "int"));
...
mysql_select_db($databate_lmp, $lmp);
$query_rste_05 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.te_05 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rste_05, "int"));
...
mysql_select_db($databate_lmp, $lmp);
$query_rste_06 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.te_06 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rste_06, "int"));
...
mysql_select_db($databate_lmp, $lmp);
$query_rste_07 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.te_07 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rste_07, "int"));
...
mysql_select_db($databate_lmp, $lmp);
$query_rste_08 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.te_08 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rste_08, "int"));
...
mysql_select_db($databate_lmp, $lmp);
$query_rste_09 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.te_09 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rste_09, "int"));
...
mysql_select_db($databate_lmp, $lmp);
$query_rste_10 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.te_10 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rste_10, "int"));
...
$query_rsqa_01 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qa_01 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqa_01, "int"));
...
mysql_select_db($databaqa_lmp, $lmp);
$query_rsqa_02 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qa_02 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqa_02, "int"));
...
mysql_select_db($databaqa_lmp, $lmp);
$query_rsqa_03 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qa_03 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqa_03, "int"));
...
mysql_select_db($databaqa_lmp, $lmp);
$query_rsqa_04 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qa_04 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqa_04, "int"));
...
mysql_select_db($databaqa_lmp, $lmp);
$query_rsqa_05 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qa_05 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqa_05, "int"));
...
mysql_select_db($databaqa_lmp, $lmp);
$query_rsqa_06 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qa_06 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqa_06, "int"));
...
mysql_select_db($databaqa_lmp, $lmp);
$query_rsqa_07 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qa_07 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqa_07, "int"));
...
mysql_select_db($databaqa_lmp, $lmp);
$query_rsqa_08 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qa_08 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqa_08, "int"));
...
mysql_select_db($databaqa_lmp, $lmp);
$query_rsqa_09 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qa_09 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqa_09, "int"));
...
mysql_select_db($databaqa_lmp, $lmp);
$query_rsqa_10 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qa_10 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqa_10, "int"));
...
$query_rsqi_01 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qi_01 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqi_01, "int"));
...
mysql_select_db($databaqi_lmp, $lmp);
$query_rsqi_02 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qi_02 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqi_02, "int"));
...
mysql_select_db($databaqi_lmp, $lmp);
$query_rsqi_03 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qi_03 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqi_03, "int"));
...
mysql_select_db($databaqi_lmp, $lmp);
$query_rsqi_04 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qi_04 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqi_04, "int"));
...
mysql_select_db($databaqi_lmp, $lmp);
$query_rsqi_05 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qi_05 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqi_05, "int"));
...
mysql_select_db($databaqi_lmp, $lmp);
$query_rsqi_06 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qi_06 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqi_06, "int"));
...
mysql_select_db($databaqi_lmp, $lmp);
$query_rsqi_07 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qi_07 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqi_07, "int"));
...
mysql_select_db($databaqi_lmp, $lmp);
$query_rsqi_08 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qi_08 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqi_08, "int"));
...
mysql_select_db($databaqi_lmp, $lmp);
$query_rsqi_09 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qi_09 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqi_09, "int"));
...
mysql_select_db($databaqi_lmp, $lmp);
$query_rsqi_10 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.qi_10 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rsqi_10, "int"));
...
$query_rssx_01 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.sx_01 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rssx_01, "int"));
...
mysql_select_db($databasx_lmp, $lmp);
$query_rssx_02 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.sx_02 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rssx_02, "int"));
...
mysql_select_db($databasx_lmp, $lmp);
$query_rssx_03 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.sx_03 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rssx_03, "int"));
...
mysql_select_db($databasx_lmp, $lmp);
$query_rssx_04 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.sx_04 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rssx_04, "int"));
...
mysql_select_db($databasx_lmp, $lmp);
$query_rssx_05 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.sx_05 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rssx_05, "int"));
...
mysql_select_db($databasx_lmp, $lmp);
$query_rssx_06 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.sx_06 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rssx_06, "int"));
...
mysql_select_db($databasx_lmp, $lmp);
$query_rssx_07 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.sx_07 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rssx_07, "int"));
...
mysql_select_db($databasx_lmp, $lmp);
$query_rssx_08 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.sx_08 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rssx_08, "int"));
...
mysql_select_db($databasx_lmp, $lmp);
$query_rssx_09 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.sx_09 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rssx_09, "int"));
...
mysql_select_db($databasx_lmp, $lmp);
$query_rssx_10 = sprintf("SELECT M.membro_apelido FROM .membros M, .vinc_membros_grupos V WHERE M.sx_10 = 'Y' AND M.membro_tipo = '1' AND V.v_id_grupo = %s AND V.v_id_membro = M.id_membro ORDER BY M.membro_apelido ASC", GetSQLValueString($colname_rssx_10, "int"));
...
<body>
<p class="titulogrande">Horário do Grupo &quot;<?php echo $row_rsGrupo['grupo_nome']; ?>&quot;</p>
