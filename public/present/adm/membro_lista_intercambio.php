...
$query_rsMembros = "SELECT id_membro, membro_nome, membro_apelido, membro_nivel FROM membros WHERE membro_tipo = 3 ORDER BY membro_nome ASC";
...
<body>
<div align="center"><span class="titulogrande">Lista de Membros em Intercâmbio do LMP</span>
