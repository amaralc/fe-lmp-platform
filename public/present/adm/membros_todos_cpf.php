...
mysql_select_db($database_lmp, $lmp);
$query_rsMembrosGrupo = "SELECT M.id_membro, M.membro_nome, M.membro_apelido, M.membro_nivel, M.membro_email, M.membro_telefone1,M.membro_telefone2, M.membro_cpf, M.foto FROM .membros M WHERE M.membro_tipo = '1' ORDER BY M.membro_nome ASC";
...
<title>Lista dos Membros do Laboratório</title>
<link href="../estilo-texto.css" rel="stylesheet" type="text/css" />
</head>

<body>
<p class="titulogrande">Lista dos Membros do Laboratório</p>
<table width="98%" border="0" cellspacing="2" cellpadding="2">
  ...
  <?php do { ?>
    <tr class="tabelaHorario">
      ...
      <td><?php echo $row_rsMembrosGrupo['membro_telefone2']; ?></td>
      <td><?php echo $row_rsMembrosGrupo['membro_cpf']; ?></td>
      <td>&nbsp;</td>
    </tr>
