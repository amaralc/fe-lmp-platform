...
$query_rsMembros = "SELECT id_membro, membro_nome, membro_apelido, membro_nivel FROM membros WHERE membro_tipo = 4 ORDER BY membro_nome ASC";
...
<body>
<div align="center"><span class="titulogrande">Membros Inativos do LMP</span>
