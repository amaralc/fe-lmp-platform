...
mysql_select_db($database_lmp, $lmp);
$query_rsMembrosGrupo = "SELECT M.id_membro, M.membro_nome, M.membro_apelido, M.membro_nivel, M.membro_email, M.membro_telefone1, M.foto FROM .membros M WHERE M.membro_tipo = '1' ORDER BY M.membro_nome ASC";
