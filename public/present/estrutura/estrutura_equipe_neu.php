...
<div align="center">
  <table width="85%" cellspacing="0">
    ...
    <?php do { ?>
      <tr>
        <td>&nbsp;</td>
        <td valign="top"><div align="center"><img src="fotos_equipe/<?php echo $row_rsApoio['foto']; ?>" alt=""></div></td>
        <td valign="middle"><ul>
...
$totalRows_rsGruposdomembro = mysql_num_rows($rsGruposdomembro);?>
      <tr>
        <td>&nbsp;</td>
        <td valign="top"><div align="center"><img src="fotos_equipe/<?php echo $row_rsPesquisadores['foto']; ?>" alt=""></div></td>
        <td valign="middle"><ul>
...
$totalRows_rsGruposdomembro = mysql_num_rows($rsGruposdomembro);
      ...
      <tr>
        <td>&nbsp;</td>
        <td valign="top"><div align="center"><img src="fotos_equipe/<?php echo $row_rsDoutorandos['foto']; ?>" alt=""></div></td>
        <td valign="middle"><ul>
...
$totalRows_rsGruposdomembro = mysql_num_rows($rsGruposdomembro);
	?>
      <tr>
        <td>&nbsp;</td>
        <td align="center" valign="top"><img src="fotos_equipe/<?php echo $row_rsMestrando['foto']; ?>" alt=""></td>
        <td valign="middle"><ul>
...
$totalRows_rsGruposdomembro = mysql_num_rows($rsGruposdomembro);
	...
	?>
      <tr>
        <td>&nbsp;</td>
        <td align="center" valign="top"><img src="fotos_equipe/<?php echo $row_rsGrad['foto']; ?>" alt="leo"></td>
        <td valign="middle"><ul>
    ...
    <?php do { ?>
      <tr>
        <td>&nbsp;</td>
        <td align="center" valign="top"><img src="fotos_equipe/<?php echo $row_rsAlunointercambio['foto']; ?>" border="0"></td>
        <td valign="middle"><ul>
